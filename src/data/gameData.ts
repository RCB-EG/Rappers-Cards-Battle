...
import { Card, PackType, PackData, FBCChallenge, Evolution, FormationLayoutId, Stats, Objective, Rank, BlitzRank, PlayerPickConfig } from '../types';
...
export const packs: Record<PackType, PackData> = {
  free: { cost: 0, bpCost: 0, rarityChances: { bronze: 65, silver: 25, gold: 10 } },
  bronze: { cost: 500, bpCost: 50, rarityChances: { bronze: 90, silver: 9, gold: 1 } },
  builder: { cost: 1200, bpCost: 120, rarityChances: { bronze: 45, silver: 35, gold: 20 } },
  special: { cost: 4000, bpCost: 400, rarityChances: { silver: 10, gold: 83, rotm: 4, icon: 3 } },
  legendary: { cost: 40000, bpCost: 4000, rarityChances: { gold: 70, rotm: 15, icon: 14, legend: 1 } },
};
...
export const superpowerIcons: Record<string, string> = {
    'Rhymes Crafter': 'https://img.icons8.com/color/48/scroll.png',
    'Flow Switcher': 'https://img.icons8.com/color/48/water-element.png',
    'The Artist': 'https://img.icons8.com/color/48/paint-palette.png',
    'Chopper': 'https://img.icons8.com/color/48/knife.png',
    'Show Maker': 'https://img.icons8.com/color/48/spotlight.png',
    'Notes Master': 'https://img.icons8.com/color/48/musical-notes.png',
    'Storyteller': 'https://img.icons8.com/color/48/book.png',
    'Punchline Machine': 'https://img.icons8.com/color/48/boxing-glove.png',
    'Words Bender': 'https://img.icons8.com/color/48/magnet.png',
    'Career Killer': 'https://img.icons8.com/color/48/skull.png',
    'Freestyler': 'https://img.icons8.com/color/48/microphone.png',
};

export const SUPERPOWER_DESC: Record<string, string> = {
    'Rhymes Crafter': 'Poisons opponent',
    'Flow Switcher': 'Chance for extra turn',
    'The Artist': 'Copies stats of strongest enemy',
    'Chopper': 'Deals damage to all enemies',
    'Show Maker': 'Buffs entire team ATK',
    'Notes Master': 'Taunts enemies',
    'Storyteller': 'Becomes untargetable',
    'Punchline Machine': 'Stuns opponent',
    'Words Bender': 'Lifesteal attack',
    'Career Killer': 'Instakill low HP enemies',
    'Freestyler': 'High crit chance or miss',
};

export const rankSystem: Record<Rank, { winsToPromote: number, teamSize: number, aiDifficulty: string, cpuOvrRange: [number, number], promotionReward: { coins: number, packs: PackType[], picks: string[] } }> = {
    'Bronze': { winsToPromote: 3, teamSize: 5, aiDifficulty: 'easy', cpuOvrRange: [60, 65], promotionReward: { coins: 1000, packs: ['bronze'], picks: [] } },
    'Silver': { winsToPromote: 5, teamSize: 6, aiDifficulty: 'normal', cpuOvrRange: [65, 75], promotionReward: { coins: 3000, packs: ['builder'], picks: [] } },
    'Gold': { winsToPromote: 7, teamSize: 8, aiDifficulty: 'hard', cpuOvrRange: [75, 85], promotionReward: { coins: 10000, packs: ['special'], picks: [] } },
    'Legend': { winsToPromote: 10, teamSize: 11, aiDifficulty: 'expert', cpuOvrRange: [85, 95], promotionReward: { coins: 50000, packs: ['legendary'], picks: [] } }
};

export const blitzRankSystem: Record<BlitzRank, { winsToPromote: number, promotionReward: { coins: number, bp: number, packs: PackType[], picks: string[] } }> = {
    5: { winsToPromote: 3, promotionReward: { coins: 500, bp: 100, packs: ['bronze'], picks: [] } },
    4: { winsToPromote: 4, promotionReward: { coins: 1000, bp: 200, packs: ['builder'], picks: [] } },
    3: { winsToPromote: 5, promotionReward: { coins: 2500, bp: 500, packs: ['special'], picks: [] } },
    2: { winsToPromote: 6, promotionReward: { coins: 5000, bp: 1000, packs: ['special'], picks: [] } },
    1: { winsToPromote: 10, promotionReward: { coins: 15000, bp: 3000, packs: ['legendary'], picks: [] } },
};

export const playerPickConfigs: Record<string, PlayerPickConfig> = {
    'pp_1of3_gold': { id: 'pp_1of3_gold', nameKey: 'pp_1of3_75', pickCount: 1, totalOptions: 3, minOvr: 75, rarityGuarantee: 'gold' }
};
